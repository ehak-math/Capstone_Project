                ...
                <div class="row g-2 mt-2">
                    ...
                    <div class="info-coures rounded mt-2">
                        ...
                        <div class="card shadow mt-5">
                            ...
                            <div class="card-body">
                                <h5 class="text-muted">Hello, {{$student->stu_fname}}</h5>
                                ...
                                @else
                                    ...
                                    <p><strong>Time:</strong> {{$subAttendance->att_startime}} <span
                                            class="text-muted">to</span> {{$subAttendance->att_endtime}}</p>

                                    @if($subAttendance->att_status == 'Open')
                                        @if($selectAttSub->att_sub_status == 'Present')
                                            <div class="alert alert-success">
                                                <i class="fas fa-check-circle me-2"></i>
                                                You have already submitted your attendance. Status:
                                                <strong>{{$selectAttSub->att_sub_status}}</strong>
                                            </div>
                                        @else
                                            <form action="{{ route('student.course.submit') }}" method="POST" class="needs-validation"
                                                novalidate>
                                                @csrf
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="code_sub" id="code_sub" required placeholder="Enter attendance code">
                                                    @error('code_sub')
                ...
                <form action="{{ route('student.course.submit') }}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input type="text"
                                class="form-control form-control-lg @error('code_sub') is-invalid @enderror"
                                name="code_sub" id="code_sub" required autocomplete="off" pattern="[A-Za-z0-9]+"
